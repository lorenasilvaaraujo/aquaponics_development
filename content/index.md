...
> 🔎 Use the search (top left) to find something specific, or browse the [table of all papers](/papers.base) grouped by plant.

## Data Tables

> [!info] The full trial and measurement dataset behind these notes is also available as raw data: [trials.csv](/trials.csv) &middot; [plant_measurements.csv](/plant_measurements.csv). Each paper's own trial parameters and measurements are also embedded at the bottom of its note.
