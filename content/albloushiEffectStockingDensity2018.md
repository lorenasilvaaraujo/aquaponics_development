---
title: "Effect of Stocking Density Using Tilapia Oreochromis niloticus on Aquaponic System and Cultivation of Cherry Tomato Solanum lycopersicum under UAE Condition"
citekey: "albloushiEffectStockingDensity2018"
year: 2018
type: experiment
doi: "NR"
...
* **Item type:** Master's Thesis (not Journal Article — see Extraction notes; zotero-export.csv mislabels this `journalArticle`)
* **Authors:** [[A. Al Bloushi]] — single author (see Extraction notes on the Zotero two-author split)
...
* **URL:** https://scholarworks.uaeu.ac.ae/bio_theses/15
* **PDF:** `Bloushi and Hussain - Effect of Stocking Density Using Tilapia Oreochromis Niloticuson Aquaponic System and Cultivation of.pdf`
...
> - **Treatments/Trials:** T1 = 100 fish/m³, T2 = 120 fish/m³, T3 = 140 fish/m³ (see `trials.csv`).
> - **Statistics:** One-way ANOVA followed by Duncan's Multiple Range Test (DMRT) post hoc, P<0.05, SPSS v16.0 (Section 2.10).
